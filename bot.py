...
FORMATS = {
    "text": 50.0, "message": 50.0, "response": 50.0, "auto-message": 50.0,
    "screen-capture": 53.0, "audio / min": 52.0, "live-stream / min": 52.5,
    "photo": 54.0, "priority-list": 54.0, "audio-call / min": 55.0,
    "video / min": 56.0, "community": 56.0, "video-call / min": 51.8,
}
...
URGENCY = {"no urgency": 0, "urgent (sfw)": 9615, "urgent (nsfw)": 15385}
